...
- 当前计划采用 GitHub Release 分发。
- 低成本开源分发会使用 ad-hoc 签名，不使用付费 Developer ID 和 notarization。
- 首次打开可能遇到 macOS Gatekeeper 提示，需要用户手动允许。
- TUN 服务安装需要管理员授权，这是 macOS 网络权限要求。
